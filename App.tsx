  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#0f172a', color: '#e2e8f0', fontFamily: 'system-ui' }}>
      <div style={{ backgroundColor: '#1e293b', padding: '12px 20px', borderBottom: '1px solid #334155' }}>
        <div style={{ fontSize: '20px', fontWeight: '700' }}>TechFlow MSP - Test Version</div>
          ...
          {selectedTicket && (
            <div>
              ...
              <div style={{ marginTop: '20px', padding: '16px', backgroundColor: '#1e293b', borderRadius: '8px' }}>
                <h3>Basic functionality restored!</h3>
                <p>This minimal version should deploy without errors.</p>
              </div>
            </div>
          )}
        </div>
